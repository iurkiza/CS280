...
class OAException
{
  public:
    ...
    enum OA_EXCEPTION
    {
        ...
        E_BAD_BOUNDARY,   // block address is not in a page or not on any block-boundary
...
class ObjectAllocator
{
  ...
  private:
    ...
    bool            is_on_freelist(void* Object);   //checks if an object is in FreeList_
    bool            is_in_pageList(void* Object);   //checks if an adress is inside the Pages
